...
grouped = group data1 by (user_location_country,is_package);
 counted = FOREACH grouped GENERATE group as is_package, COUNT(data1) as cnt;
 result = FOREACH counted GENERATE is_package.user_location_country,is_package.is_package, cnt;
